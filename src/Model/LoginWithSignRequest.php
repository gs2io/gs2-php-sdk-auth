...
class LoginWithSignRequest extends Gs2BasicRequest {
	 ...
	 */
	public function withServiceId(string $serviceId): LoginWithSignRequest {
	 ...
	 * @return LoginWithSignRequest
	 */
	public function withUserId(string $userId): LoginWithSignRequest {
	 ...
	 * @return LoginWithSignRequest
	 */
	public function withKeyName(string $keyName): LoginWithSignRequest {
	 ...
	 * @return LoginWithSignRequest
	 */
	public function withSign(string $sign): LoginWithSignRequest {
		$this->setSign($sign);
		return $this;
	}
